...
type StressTestLoaderClient interface {
	...
	GetStressTestStatus(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestReply, error)
}
...
func (c *stressTestLoaderClient) GetStressTestStatus(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestReply, error) {
	out := new(TestReply)
	err := c.cc.Invoke(ctx, "/stresstestloader.StressTestLoader/GetStressTestStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StressTestLoaderServer interface {
	...
	GetStressTestStatus(context.Context, *TestRequest) (*TestReply, error)
...
func (UnimplementedStressTestLoaderServer) GetStressTestStatus(context.Context, *TestRequest) (*TestReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStressTestStatus not implemented")
}
...
func _StressTestLoader_GetStressTestStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StressTestLoaderServer).GetStressTestStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stresstestloader.StressTestLoader/GetStressTestStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StressTestLoaderServer).GetStressTestStatus(ctx, req.(*TestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StressTestLoader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStressTestStatus",
			Handler:    _StressTestLoader_GetStressTestStatus_Handler,
		},
	},
